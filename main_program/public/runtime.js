...
const exported_js_functions = {
    ...
    // compute_num: ()=>{
    //     console.error("compute_num was not correctly compiled")
    // }
}
...
const imports = {
    "env": new Proxy(exported_js_functions, {
        get(target, prop, receiver) {
            ...
            // return () => {  console.error("compute_num was not correctly compiled") };
...
WebAssembly.instantiateStreaming(fetch("runtime.wasm"), imports).then(
    (obj) => {
